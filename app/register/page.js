...
/>
  ...
  className="w-full rounded-xl border border-slate-700 bg-slate-900 px-4 py-3 pr-20 text-white outline-none focus:border-blue-500"
  required
/>
...
{success && (
  ...
  type="submit"
  disabled={loading}
  className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-4 font-bold text-white shadow-lg shadow-blue-500/20 hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
>
