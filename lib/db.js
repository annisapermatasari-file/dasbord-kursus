...
// Catatan: koleksi `users` sudah dipindah ke Supabase — lihat lib/users-repo.js.

export async function promoRedemptions() {
  const col = (await db()).collection('promo_redemptions')
