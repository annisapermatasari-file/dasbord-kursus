...
import { listActiveAdminEmails } from '@/lib/users-repo'
...
<table role="presentation" width="640" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(15,23,42,0.08)">
  <tr><td style="background:linear-gradient(135deg,${brand} 0%,${accent} 100%);padding:26px 32px;color:#ffffff">
    <div style="font-size:11px;letter-spacing:.16em;text-transform:uppercase;opacity:.85">SocialPulse</div>
  ...
  <tr><td style="padding:20px 32px 26px">
    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:10px;padding:16px">
      <div style="font-size:12px;color:#334155;line-height:1.6">
        ...
        • Konten yang menampilkan cerita dan testimoni biasanya menghasilkan engagement tertinggi.<br>
        • Gunakan hashtag brand Anda secara konsisten di setiap post.
      </div>
    </div>
  </td></tr>
  ...
  <tr><td style="padding:16px 32px;background:#F8FAFC;border-top:1px solid #E2E8F0">
    <p style="margin:0;font-size:11px;color:#64748B;line-height:1.6">
      Email ini dikirim otomatis oleh SocialPulse setiap Senin pagi.<br>
