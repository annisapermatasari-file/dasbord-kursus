...
const TITLE_TEMPLATES = [
  ...
  'Live Bersama Direktorat: {topic}', 'Highlight Acara {topic}', 'Sorotan Pekan Ini: {topic}',
]
...
// ---------- SENTIMENT ----------
const POS_COMMENTS = [
  'Terima kasih Direktorat, program kursus sangat membantu!','Saya alumni LKP dan sekarang bekerja di industri, sangat bangga.',
...
export function generateWebsite(days = 30) {
  ...
  const topPages = [
    ...
    { path: '/berita', views: Math.round(totals.pageViews*0.09), title: 'Berita Direktorat' },
    ...
    { path: '/tentang', views: Math.round(totals.pageViews*0.04), title: 'Tentang Direktorat' },
  ]
  const sources = [
